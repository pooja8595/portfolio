        ...
        <SafeAreaView style={{ backgroundColor: '#fff', flex: 1 }}>
            ...
            <ScrollView>
                <View style={{ marginHorizontal: 10, marginVertical: 10 }}>
                    <Text style={{ color: '#000', fontSize: 15, fontWeight: 500 }}>Project # 2</Text>
                </View>
                <View style={{ flexDirection: 'row', marginHorizontal: 10, alignItems: 'center' }}>
                    <Image
                        source={require('../Assets/vesta.png')}
                        style={{
                            height: 50,
                            width: 50,
                            resizeMode: 'contain',
                    ...
                    />
                    <View>
                        <Text style={{ color: '#000', fontSize: 15, marginLeft: 10, fontWeight: 500 }}>Vesta Doctor App</Text>
                        <Text style={{ color: '#000', fontSize: 10, marginLeft: 10 }}>Vesta Elder Care</Text>
                    </View>
                </View>
            ...
            <TouchableOpacity style={{ alignSelf: 'flex-end', marginHorizontal: 10, marginBottom: 50, backgroundColor: "#0200fe", paddingHorizontal: 30, paddingVertical: 10, marginVertical: 10, borderRadius: 5 }} onPress={() => navigation?.navigate('Akiko')}>
